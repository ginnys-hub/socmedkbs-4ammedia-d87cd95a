export type Announcement = {
  id: string;
  posted_on: string; // ISO
  title: string;
  body: string;
  category: "update" | "reminder" | "issue" | "resolved" | "important";
};
...
export const ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    category: "update",
    body: `Guys, moving forward, if may mareceive kayo na ganito, please send it to our escalation channel instead:

https://fourammedia.slack.com/archives/C0C0ETHT17B

Please include the full screenshot of the message po ha.
